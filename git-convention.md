# GIT - Các quy tắc chung

![gitwordflow](https://wac-cdn.atlassian.com/dam/jcr:b5259cce-6245-49f2-b89b-9871f9ee3fa4/03%20(2).svg?cdnVersion=966)

Các quy tắc trong việc sử dụng GIT để quản lý dự án là rất nhiều. Ở đây, chúng ta chỉ nói tới những quy tắc
cơ bản nhất để áp dụng GIT vào 1 dự án với teamsize < 5 người

## Branch

- `master`: là nhánh chính, sử dụng để lưu lại từng cột mốc trong dự án. Đây là nhánh mặc định khi tạo mới 01 repository trên git. Nếu sử dụng CI/CD, đây cũng là branch để lắng nghe sự kiện.
...
- Các nhánh cá nhân là: tên người + chữ cái đầu tiền của họ + chữ cái đầu tiên của tên đệm. Ví dụ: Nguyễn Đức Thuận => `thuannd`
